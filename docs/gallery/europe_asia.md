...
t = europe_asia_temperature_field()
p = europe_asia_pressure_field()
u, v = europe_asia_wind_fields()
```

## 温度填充

```{code-cell} python
panel = Panel(domain=EuropeAsiaMapTemplate())
